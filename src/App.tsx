  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-indigo-500 selection:text-white">
      ...
      <main className="flex-1 max-w-xl w-full mx-auto p-4 pb-24 space-y-6">
        ...
        {activeTab === 'badges' && (
          <div className="space-y-6 animate-in fade-in duration-300">
            <h2 className="text-base font-bold text-slate-200">Badges & Trophies</h2>
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-slate-900/80 border border-indigo-500/30 p-4 rounded-2xl flex items-center gap-3.5 shadow-lg">
                <div className="p-3 bg-indigo-500/10 text-indigo-400 rounded-xl">
                  <Sparkles className="w-6 h-6" />
                </div>
                <div>
                  <h3 className="text-sm font-bold text-slate-200">First Step</h3>
                  <p className="text-[10px] text-slate-400 mt-0.5">Initiated system</p>
                </div>
              </div>
              <div className="bg-slate-900/80 border border-slate-800 p-4 rounded-2xl flex items-center gap-3.5 opacity-60">
      ...
      {/* Bottom Navigation */}
      <nav className="h-16 border-t border-slate-800/80 bg-slate-900/80 backdrop-blur-md px-6 flex items-center justify-around fixed bottom-0 left-0 right-0 z-40">
        <button 
          onClick={() => setActiveTab('today')}
          className={`flex flex-col items-center gap-1 text-[10px] font-medium transition-colors ${activeTab === 'today' ? 'text-indigo-400 font-bold' : 'text-slate-500 hover:text-slate-300'}`}
        >
        ...
        <button 
          ...
          className={`flex flex-col items-center gap-1 text-[10px] font-medium transition-colors ${activeTab === 'focus' ? 'text-indigo-400 font-bold' : 'text-slate-500 hover:text-slate-300'}`}
        >
        ...
        <button 
          ...
          className={`flex flex-col items-center gap-1 text-[10px] font-medium transition-colors ${activeTab === 'stats' ? 'text-indigo-400 font-bold' : 'text-slate-500 hover:text-slate-300'}`}
        >
        ...
        <button 
          ...
          className={`flex flex-col items-center gap-1 text-[10px] font-medium transition-colors ${activeTab === 'badges' ? 'text-indigo-400 font-bold' : 'text-slate-500 hover:text-slate-300'}`}
        >
