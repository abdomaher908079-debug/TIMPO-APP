...
export default function App() {
  ...
  // Send system desktop/mobile notification
  ...
  // Dynamic schedule health calculations
    ...
    <div className="min-h-screen bg-[#090D16] text-slate-100 flex flex-col font-sans">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 py-8 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <section className="lg:col-span-4 space-y-6">
          ...
          {/* Notifications Permission Widget */}
          <div className="glass-card rounded-2xl p-5 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Bell className="w-5 h-5 text-indigo-400" />
              <div>
                <p className="text-xs font-bold text-white">Push Notifications</p>
                <p className="text-[10px] text-slate-400">Get schedule alerts on mobile</p              </div>
            </div>
            <button
              onClick={() => {
